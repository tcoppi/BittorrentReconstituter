...
improve the state of network forensics on this front.
\end{abstract}
%\keywords{}
...
number of the major piece it is contained in and the offset within this
...
logical files, verify the piece SHA-1 hashes, and use them to piece together the
original file. Separation of multiple files and verification of the hashes both
require that the original \texttt{.torrent} file is specified.
